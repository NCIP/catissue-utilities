...
public class gridLoginClient {
	 ...
	 */
	public  SAMLAssertion authenticate (String url, String username, String password) 
	{
	 ...
	 */
	public  GlobusCredential authorize (String url, SAMLAssertion saml) 
	{
	...
	/**
	 * Logs a caGrid user onto the Production Grid via authenticate and authorize
	 * steps against the Dorian grid service.
	 * 
	 * @param username	A caGrid username from the caGrid Production Grid
	 * @param password	The caGrid password
	 */
	public static void main(String[] args) {
		...
		SAMLAssertion saml = client.authenticate (url, args[0], args[1]);
